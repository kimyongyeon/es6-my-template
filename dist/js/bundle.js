...
console.log(_lib_js__WEBPACK_IMPORTED_MODULE_1__.pi);
console.log((0,_lib_js__WEBPACK_IMPORTED_MODULE_1__.power)(_lib_js__WEBPACK_IMPORTED_MODULE_1__.pi, _lib_js__WEBPACK_IMPORTED_MODULE_1__.pi));
var f = new _lib_js__WEBPACK_IMPORTED_MODULE_1__.Foo();
console.log(f.foo());
console.log(f.bar()); // polyfill 이 필요한 코드
